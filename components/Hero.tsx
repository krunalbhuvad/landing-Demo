  ...
  return (
    <section className="section-wrapper pb-20 pt-20 sm:pb-24 sm:pt-24">
      <div className="mx-auto max-w-3xl text-center">
        <p className="animate-fade-in-up mb-5 inline-flex rounded-full border border-cyan-300/30 bg-cyan-300/10 px-3 py-1 text-xs font-medium uppercase tracking-[0.2em] text-cyan-200">
          AI workflow automation platform
        </p>

        <h1
          className="animate-fade-in-up text-4xl font-semibold leading-tight tracking-tight text-white sm:text-5xl lg:text-6xl"
        ...
        <p
          className="animate-fade-in-up mx-auto mt-6 max-w-2xl text-base text-slate-300 sm:text-lg"
